defmodule ZipperTest do
  ...
  test "left and value" do
    assert t1() |> from_tree() |> left() |> value() == 2
  end

  test "from_tree and to_tree" do
    assert t1() |> from_tree() |> to_tree() == t1()
  end

  test "left and to_tree" do
    assert t1() |> from_tree() |> left() |> to_tree() == t1()
  end

  test "right and value" do
    assert t1() |> from_tree() |> right() |> value() == 4
  end
